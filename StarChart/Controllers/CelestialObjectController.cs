...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        public IActionResult Update(int id, CelestialObject celestialObject)
        {
            ...
            if (existingObject is null) return NotFound();
        ...
        {
            var existingObjects = _context.CelestialObjects.Where(x => x.Id == id || x.OrbitedObjectId == id).ToList();
            if (!existingObjects.Any()) return NotFound();
